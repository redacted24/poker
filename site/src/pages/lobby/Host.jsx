...
const Host = ({ socket, notify }) => {
    ...
    const handleChange = (e) => {
        ...
        if (e.target.id == "bigBlindAmount") {
            newOptions["smallBlindAmount"] =
                e.target.value * increments["smallBlindAmount"];
        } else {
                    ...
                    <div id="options">
                        <div className="section">
                            ...
                            <div className="option">
                                ...
                                >
                                    Staring balance: {options.startingBalance}$
                                </label>
                                <input
                                    type="range"
                                    min="1"
                                    max="25"
                                    value={options.startingBalance / 200}
                            ...
                            <div className="option">
                                <label
                                    className="option-label"
                                    htmlFor="smallBlindAmount"
                                >
                                    Small blind amount:{" "}
                                    {options.smallBlindAmount}$
                                </label>
                                <input
                                    type="range"
                                    min="0"
                                    max="20"
                                    value={options.smallBlindAmount / 5}
                                    onChange={handleChange}
                                    className="option-slider"
                                    id="smallBlindAmount"
                                />
                            ...
                            <div className="option">
                                <label
                                    className="option-label"
                                    htmlFor="blindInterval"
                                >
                                    Blind interval: +{options.blindInterval}$
                                    per round
                                </label>
                                <input
                                    type="range"
                        ...
                        <div className="section">
                            ...
                            <div className="option checkbox">
                                <label
                                    className="option-label inline"
                                    htmlFor="showAllBotCards"
                                >
                                    Show cards for bots
                                </label>
                                <input
                                    type="checkbox"
                                    checked={options.showAllBotCards}
                                    onChange={handleCheckChange}
                                    className="option-checkbox"
                                    id="showAllBotCards"
                                />
                            ...
                            <div className="option checkbox">
                                <label
                                    className="option-label inline"
                                    htmlFor="showAllCards"
                                >
                                    Show cards for everyone
                                </label>
                                <input
                                    type="checkbox"
                                    checked={options.showAllCards}
                                    onChange={handleCheckChange}
                                    className="option-checkbox"
                                    id="showAllCards"
                                />
                            ...
                            <p id="warning">
                                Warning: every player in the game will receive
                                these cheats!
                            </p>
                        </div>
                        ...
                        <button id="host-start" onClick={startGame}>
                            Start
                        </button>
                    </div>
                </div>
